...
class DataPretreatFlow {
  ...
  private:
    ...
    std::shared_ptr<OdometrySubscriber> velocity_sub_ptr_;
    std::shared_ptr<OdometrySubscriber> pose_sub_ptr_;
    ...
    // models
    std::shared_ptr<DistortionAdjustCustom> distortion_adjust_ptr_;
